...
var ssImage;
 ...
 function loadImages(){
   bsImage = new Image();
  bsImage.src = "resources/images/sprites/buttons.png";
   ssImage = new Image();
   ssImage.src = "resources/images/sprites/spritesheet.png";
...
class Game {
  ...
  loadWallImage(){
   ...
   var propName =  "B60000";
   var f = buttons.frames[propName].frame;
...
//       }
  ...
  createTileDivs(){
    var tiles = [];
    var buttIds = ["B10000", "B20000", "B30000", "B40000", "B50000", "B60000"];
    ...
    for(var i = 0; i < 5; i++){
      ...
      */
      var b = buttIds[i];
      var button = buttons.frames[b].frame;
      ...
      innerDiv.style.backgroundImage = "url(resources/images/sprites/buttons.png)";
